...
<div class="wrapper">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            <img src="{{ asset('static/admin/images/adminlte/user2-160x160.jpg') }}" class="user-image" alt="User Image">
                            <!-- hidden-xs hides the username on small devices so only the image appears. -->
                            <span class="hidden-xs">Sunrise</span>
                        </a>
                        <ul class="dropdown-menu">
    ...
    <footer class="main-footer">
        ...
        <!-- Default to the left -->
        <strong>Copyright &copy; 2016 <a href="{{ route('admin.index') }}">Sample</a>.</strong> All rights reserved.
    </footer>
